...
function sizeEditorCorrectly() {
  ...
  Player.readOnly && ($(window).width() < 900 ? ($('#sidebar-ads').hide(), $(window).width() < 600 ? $('#player_container').addClass('narrow')  : $('#player_container').removeClass('narrow'))  : ($('#sidebar-ads').show(), $('#player_container').removeClass('narrow')))
}
...
function NumToWords() {
  function e(r, i) {
    ...
    r < 1000 ? s : e(Math.floor(r / 1000), i + 1) + (s == '' ? '' : ', ' + s)
  }
  function t(e) {
    return e == 0 ? '' : e < 10 ? n.digits[e - 1] : e < 20 ? n.teens[e - 10] : e < 100 ? n.tens[Math.floor(e / 10) - 1] + (e % 10 == 0 ? '' : '-' + n.digits[e % 10 - 1])  : e < 1000 ? n.digits[Math.floor(e / 100) - 1] + ' hundred' + (e % 100 == 0 ? '' : ' and ' + t(e % 100))  : e
  }
  ...
  s = function () {
    ...
    return i.fn = i.prototype = {
      ...
      init: function (e, r, s) {
        ...
        this;
        if (typeof e == 'string') {
          e.charAt(0) === '<' && e.charAt(e.length - 1) === '>' && e.length >= 3 ? o = [
            null,
            e,
            null
          ] : o = a.exec(e);
          if (o && (o[1] || !r)) {
            ...
            f = h.exec(e),
            f ? i.isPlainObject(r) ? (e = [
              n.createElement(f[1])
            ], i.fn.attr.call(e, r, !0))  : e = [
              l.createElement(f[1])
            ] : (f = i.buildFragment([o[1]], [
              l
    ...
    i.extend = i.fn.extend = function () {
      ...
      for (; f < l; f++) if ((e = arguments[f]) != null) for (n in e) {
        ...
        s = e[n];
        if (a === s) continue;
        c && s && (i.isPlainObject(s) || (o = i.isArray(s))) ? (o ? (o = !1, u = r && i.isArray(r) ? r : [
  ...
  s.Callbacks = function (e) {
    ...
    p = function (t, s) {
      ...
      a = !1,
      n && (e.once ? i === !0 ? d.disable()  : n = [
      ] : r && r.length && (i = r.shift(), d.fireWith(i[0], i[1])))
    },
    d = {
      add: function () {
        if (n) {
          ...
          return s.Deferred(function (r) {
            s.each({
              ...
              s.isFunction(n) ? a[e](function () {
                ...
                o && s.isFunction(o.promise) ? o.promise().then(r.resolve, r.reject, r.notify)  : r[i + 'With'](this === a ? r : this, [
                  o
                ])
              })  : a[e](r[i])
            })
  ...
  s.extend({
    ...
    removeData: function (e, t, n) {
      ...
      if (t) {
        r = n ? f[l] : f[l].data;
        if (r) {
          s.isArray(t) || (t in r ? t = [
            t
          ] : (t = s.camelCase(t), t in r ? t = [
            t
          ] : t = t.split(' ')));
  ...
  s.fn.extend({
    data: function (e, n) {
      ...
      if (typeof e == 'undefined') {
        if (this.length) {
          ...
          if (this[0].nodeType === 1 && !s._data(this[0], 'parsedAttrs')) {
            i = this[0].attributes;
            for (var a = 0, f = i.length; a < f; a++) o = i[a].name,
      ...
      return typeof e == 'object' ? this.each(function () {
        s.data(this, e)
      })  : (r = e.split('.'), r[1] = r[1] ? '.' + r[1] : '', n === t ? (u = this.triggerHandler('getData' + r[1] + '!', [
        r[0]
      ]), u === t && this.length && (u = s.data(this[0], e), u = c(this[0], e, u)), u === t && r[1] ? this.data(r[0])  : u)  : this.each(function () {
        var t = s(this),
        i = [
          r[0],
          n
  ...
  }, s.attrHooks.tabindex.set = S.set, s.each(['width',
  'height'], function (e, t) {
  ...
  s.support.hrefNormalized || s.each(['href',
  'src',
  'width',
  'height'], function (e, n) {
  ...
  s.support.checkOn || s.each(['radio',
  'checkbox'], function () {
    s.valHooks[this] = {
      get: function (e) {
  ...
  s.event = {
    ...
    remove: function (e, t, n, r, i) {
      ...
      s.isEmptyObject(d) && (m = o.handle, m && (m.elem = null), s.removeData(e, [
        'events',
        'handle'
      ], !0))
    },
    ...
    trigger: function (n, r, i, o) {
      if (!i || i.nodeType !== 3 && i.nodeType !== 8) {
        ...
        if (!o && !v.noBubble && !s.isWindow(i)) {
          ...
          p = null;
          for (; h; h = h.parentNode) g.push([h,
          y]),
          p = h;
          p && p === i.ownerDocument && g.push([p.defaultView || p.parentWindow || e,
          y])
        }
        for (c = 0; c < g.length && !n.isPropagationStopped(); c++) h = g[c][0],
        n.type = g[c][1],
        m = (s._data(h, 'events') || {
        }) [n.type] && s._data(h, 'handle'),
        m && m.apply(h, r),
        m = d && h[d],
    ...
    dispatch: function (n) {
      ...
      for (f = 0; f < a.length && !n.isPropagationStopped(); f++) {
        ...
        for (l = 0; l < v.matches.length && !n.isImmediatePropagationStopped(); l++) {
          ...
          n.handleObj = g,
          p = ((s.event.special[g.origType] || {
          }).handle || g.handler).apply(v.elem, o),
  ...
  s.fn.extend({
    ...
    add: function (e, t) {
      var n = typeof e == 'string' ? s(e, t)  : s.makeArray(e && e.nodeType ? [
        e
      ] : e),
  ...
  s.extend({
    filter: function (e, t, n) {
      return n && (e = ':not(' + e + ')'),
      t.length === 1 ? s.find.matchesSelector(t[0], e) ? [
        t[0]
      ] : [
      ] : s.find.matches(e, t)
    },
  ...
  ot.th = ot.td,
  s.support.htmlSerialize || (ot._default = [
    1,
    'div<div>',
    '</div>'
  ]),
  s.fn.extend({
    ...
    remove: function (e, t) {
      for (var n = 0, r; (r = this[n]) != null; n++) if (!e || s.filter(e, [
        r
      ]).length) !t && r.nodeType === 1 && (s.cleanData(r.getElementsByTagName('*')), s.cleanData([r])),
    ...
    html: function (e) {
      ...
      if (typeof e == 'string' && !et.test(e) && (s.support.leadingWhitespace || !K.test(e)) && !ot[(G.exec(e) || [
        '',
        ''
      ]) [1].toLowerCase()]) {
        e = e.replace(Q, '<$1></$2>');
  ...
  s.extend({
    clone: function (e, t, n) {
      ...
      i,
      o,
      u = s.support.html5Clone || !nt.test('<' + e.nodeName) ? e.cloneNode(!0)  : dt(e);
  ...
  s.extend({
    ...
    ajax: function (e, n) {
      function S(e, n, c, h) {
        ...
        E.statusCode(f),
        f = t,
        b && o.trigger('ajax' + (d ? 'Success' : 'Error'), [
          E,
          r,
          d ? g : w
        ]),
  ...
  s.fn.extend({
    show: function (e, t, n) {
      ...
      for (var o = 0, u = this.length; o < u; o++) r = this[o],
    ...
    animate: function (e, t, n, r) {
      ...
      var i = s.speed(t, n, r);
      return s.isEmptyObject(e) ? this.each(i.complete, [
        !1
      ])  : (e = s.extend({
  ...
  s.fx.prototype = {
    ...
    step: function (e) {
      ...
      if (e || i >= a.duration + this.startTime) {
        ...
        if (o) {
          a.overflow != null && !s.support.shrinkWrapBlocks && s.each(['',
          'X',
          'Y'], function (e, t) {
  ...
  s.offset = {
    ...
    setOffset: function (e, t, n) {
      ...
      u = s.css(e, 'top'),
      a = s.css(e, 'left'),
      f = (r === 'absolute' || r === 'fixed') && s.inArray('auto', [
        u,
        a
      ]) > - 1,
      l = {
...
}; StoryModel.loading = !1, StoryModel.watchRefCounts = !1, StoryModel._defaultStoryName = 'Untitled Story', StoryModel._defaultAuthorName = 'Anonymous', StoryModel._storyName = StoryModel._defaultStoryName, StoryModel._authorName = StoryModel._defaultAuthorName, StoryModel.stitches = [
], StoryModel.flagIndex = [
], StoryModel.initialStitch = null, StoryModel.maxPage = 0, StoryModel.maxPreferredPageLength = 8, StoryModel.optionMirroring = !0, StoryModel.allowCheckpoints = !1, StoryModel.endCount = 0, StoryModel.looseEndCount = 0, StoryModel.storyName = function () {
  ...
  for (var e = 0; e < StoryModel.stitches.length; e++) if (StoryModel.stitches[e].options.length > 0) for (var t = 0; t < StoryModel.stitches[e].options.length; t++) StoryModel.stitches[e].options[t]._linkStitch ? StoryModel.stitches[e].options[t]._linkStitch._backlinks.push(StoryModel.stitches[e])  : StoryModel.looseEndCount++;
  ...
  if (StoryModel.watchRefCounts) for (var e = 0; e < StoryModel.stitches.length; e++) StoryModel.stitches[e]._backlinks.length !== StoryModel.stitches[e].refCount && alert('Stitch with text \'' + StoryModel.stitches[e].text() + '\' has invalid ref-count!')
  ...
  for (var i = 0; i < StoryModel.stitches.length; i++) {
    ...
    s > 0 ? (e.push(StoryModel.stitches[i]), s > t && (t = s), StoryModel.stitches[i].pageNumber(s), n[s] = [
  ...
  for (var i = e.length - 1; i >= 0; i--) {
    var o = function (t, r, s) {
      ...
      o(t.divertStitch, !1, s + 0.01);
      for (var u = 0; u < t.options.length; u++) o(t.options[u].linkStitch(), !1, s + 1 + 0.1 * u)
    };
    o(e[i], !0, 0)
  }
  var u = [
  ...
  while (u.length > 0) {
    ...
    for (var i = 0; i < u.length; i++) if (r[u[i]]) {
      r[u[i]] = !1;
  ...
  while (e.length > 0) {
    for (var n = 0; n < e.length; n++) {
      ...
      if (r.divertStitch) {
        ...
        i.verticalDistance() == - 1 && (i.verticalDistance(r.verticalDistance() + 0.01), t.push(i))
      } else for (var s = 0; s < r.options.length; s++) if (r.options[s].linkStitch()) {
        var i = r.options[s].linkStitch();
        i.verticalDistance() == - 1 && (i.verticalDistance(r.verticalDistance() + 1 + 0.1 * s), t.push(i))
      }
    }
    e = t,
    t = [
  ...
  return e && (e < this._pageNumberHeader && StoryModel.maxPage == this._pageNumberHeader && StoryModel.maxPage--, this._pageNumberHeader = e, e > StoryModel.maxPage && (StoryModel.maxPage = e)),
  ...
  return e != null && (this._text = e, this.wordCount = wordCountOf(e)),
  this._text === undefined ? (this.wordCount = 0, '')  : this._text
  ...
  this.divertStitch && (StoryModel.watchRefCounts && console.log('Undiverting ' + this.name()), this.divertStitch.decRefCount()),
  this.divertStitch = null,
  ...
  return e && this._linkStitch != e && (this._linkStitch && this._linkStitch.decRefCount(), this._linkStitch = e, this._linkStitch.incRefCount(), t || StoryModel.updateGraphModel()),
  this._linkStitch
  ...
  StoryModel.flagIndex.contains(e) || (console.log('-> ' + e), StoryModel.flagIndex.push(e))
  ...
  for (var n = 0; n < t.length; n++) if (t[n].flagName == e) return n;
  return - 1
  ...
  if (e) for (var n = 0; n < e.numberOfFlags(); n++) {
  ...
  if (e) if (n = e.match(r)) {
    ...
    n[2] == '==' || n[2] == '=' ? i = s == n[3] : n[2] == '!=' || n[2] == '<>' ? i = s !== n[3] : (n[3].match(/\d+/) || console.log('Error - Can\'t perform an order-test on a boolean.'), n[2] == '<' ? i = s < n[3] : n[2] == '<=' ? i = s <= n[3] : n[2] == '>' ? i = s > n[3] : n[2] == '>=' && (i = s >= n[3])),
  ...
  for (var t = 0; t < this.stitches.length; ++t) if (this.stitches[t] === e) {
  ...
  for (var i in r) {
    ...
    for (var S = 0; S < y.options.length; ++S) {
      ...
      if (x.ifConditions) for (var E = 0; E < x.ifConditions.length; ++E) T._ifConditions.push(x.ifConditions[E].ifCondition);
      if (x.notIfConditions) for (var N = 0; N < x.notIfConditions.length; ++N) T._notIfConditions.push(x.notIfConditions[N].notIfCondition)
    }
  }
  ...
  for (var t = 0; t < StoryModel.stitches.length; ++t) {
    ...
    if (n.divert() != null) {
      ...
      r.content.push(i)
    } else if (n.options.length > 0) for (var s = 0; s < n.options.length; ++s) {
    ...
    if (n._flags.length > 0) for (var p = 0; p < n._flags.length; ++p) {
      var d = {
        flagName: n._flags[p]
      };
      r.content.push(d)
    }
    if (n._ifConditions.length > 0) for (var p = 0; p < n._ifConditions.length; ++p) {
      var v = {
        ifCondition: n._ifConditions[p]
      };
      r.content.push(v)
    }
    if (n._notIfConditions.length > 0) for (var p = 0; p < n._notIfConditions.length; ++p) {
      var v = {
  ...
  var l = function (e) {
    ...
    if (e.which === 13) {
      ...
      t.each(function () {
        var t = $(this);
        if (t.text().match(/cancel/i)) return t.click(),
        e.preventDefault(),
        !1
      })
    }
  ...
  p = function () {
    ...
    r.css({
      left: 0.5 * t.width() - 0.5 * r.width(),
      top: 0.5 * t.height() - 0.5 * r.height()
    })
  },
  d = function (e) {
    o || (o = $('<div class="fields"></div>'), i.append(o)),
    o.append(e),
    p()
  },
  v = function (e) {
  ...
  a
}; Dialogue.keypressBoundFunction = null; var EditorAccount = function () {
  var e = 0,
  t = 'inklewriter_story',
  ...
  g = function (e) {
    $.ajax({
      ...
      error: function (t, n, r) {
        if (e && e.failure) if (t.responseText) {
  ...
  w = function (e, t, n) {
    ...
    $.ajax({
      ...
      error: function (e, t, r) {
        if (n && n.failure) if (e.responseText) {
  ...
  k = function (e) {
    !i.currentStoryId || i.currentStoryId === 'local' ? (i.currentStoryId = 'local', i.stories.local = e)  : (i.stories[i.currentStoryId] = e, i.currentStoryId != 'local' && (e.url_key = i.currentStoryId)),
    o()
  },
  L = function () {
  ...
  O = function () {
    if (C()) if (EditorMenu.unsavedChanges()) {
  ...
  M = function (t, n, s) {
    ...
    'Saving',
    'New story',
    u.length / 1000])  : _gaq.push(['_trackEvent',
    'Server Interaction',
    'Saving',
    'Resave of existing story',
    u.length / 1000]);
    if (o) $.ajax({
      type: 'POST',
      url: r + '/stories.json',
  ...
  r = function (r) {
    ...
    if (this.prevChunk) for (var s = 0; s < this.prevChunk.flagsCollected.length; s++) i.flagsCollected.push(this.prevChunk.flagsCollected[s]);
    if (!r) {
      t ? this.jqPlayChunk.html('<div class=\'the_end\'>End</div>')  : (n(), this.jqPlayChunk.html('This page intentionally left blank.<br>(<a href=\'javascript:EditorMenu.enterEditMode();\'>Continue the story from here</a>.)')),
    ...
    e.length >= 1 ? (b(this.jqPlayChunk), t && this.jqRewindButton.addClass('noText'))  : (this.jqRewindButton.addClass('initial'), t && this.jqRewindButton.text('Start again'))
  };
  ...
  r.prototype.createOptionBlock = function () {
    ...
    if (this.stitches.last().options.length == 0) this.jqTextBlock.append('<div class="the_end">End</div>'),
    t ? (this.jqTextBlock.find('.the_end').append('<div class=\'back_to_top\'></div>'), this.jqTextBlock.find('.back_to_top').bind('click tap', function () {
  ...
  r.prototype.rewindToHere = function () {
    ...
    for (var n = t + 1; n < e.length; n++) e[n].jqPlayChunk.remove(),
    e[n].remove();
    e = e.slice(0, t + 1),
    this.createOptionBlock(),
    this.jqRewindButton.hide(),
  ...
  g = function (e, t) {
    ...
    while (o = e.match(n)) {
      ...
      if (o.length > 0) {
        ...
        c = o[1].split(i);
        for (var h = 0; h < c.length; h++) if (c[h] != '&&' && c[h] != 'and') {
          var p = c[h].match(s);
  ...
  E = function (n) {
    ...
    for (var s = 0; s < n.length; s++) {
      ...
      var u = new r(n[s]);
      e.push(u);
      if (i) for (var a = 0; a < i.options.length; a++) if (i.options[a].linkStitch() === n[s]) {
        o(i.options[a]);
        break
...
}(); activeTooltip = null; var ToolTip = function (e, t, n) {
  var r = this;
  ...
  l = u.top + t.height() + 3,
  c = n.pageX - f / 2;
  l + a > s - 10 && (l = s - 10 - a, c < o / 2 ? c += 2 * f / 3 : c -= 2 * f / 3),
  c < 5 && (c = 10),
  c + f > o - 10 && (c = o - 10 - f),
  ...
  function o() {
    if (!v.initialized) {
      ...
      r = !1,
      o = !1;
      e(document, 'createRange') && (n = document.createRange(), h(n, f) && d(n, a) && (r = !0), n.detach()),
      (n = t(document, 'body') ? document.body : document.getElementsByTagName('body') [0]) && e(n, 'createTextRange') && (n = n.createTextRange(), i(n) && (o = !0)),
  ...
  if (typeof window == 'undefined') s('No window found');
    ...
    if (typeof document != 'undefined') return e(document, 'addEventListener') && document.addEventListener('DOMContentLoaded', p, !1),
  ...
  function r(e, t) {
    ...
    for (r = t; r; r = r.parentNode) if (d(n, r)) return r;
    return null
  }
  function i(e, t, n) {
  ...
  function r(e, t, n) {
    if (t = e._listeners[t]) for (var r = 0, i = t.length; r < i; ++r) t[r].call(e, {
      target: e,
      args: n
    })
  }
  ...
  function a(e, t, n) {
    ...
    for (n = n || {
      stop: !1
    }; r = e.next(); ) if (e.isPartiallySelectedSubtree()) {
      if (t(r) === !1) {
        n.stop = !0;
        return
      }
      ...
      r.detach(!0);
      if (n.stop) return
    } else for (r = D.createIterator(r); i = r.next(); ) if (t(i) === !1) {
      n.stop = !0;
      return
    }
  }
  ...
  function L(e, t) {
    return function () {
      ...
      o = new p(this, !0);
      return n !== i && (n = D.getClosestAncestorIn(n, i, !0), r = s(n), n = r.node, r = r.offset),
      a(o, S),
      o.reset(),
      i = e(o),
      o.detach(),
  ...
  function A(n, r, o) {
    ...
    function a(e, t, n) {
      ...
      if (t !== e.startContainer || n !== e.startOffset) {
        if (q(t) != q(i) || D.comparePoints(t, n, i, s) == 1) i = t,
        s = n;
        r(e, t, n, i, s)
      }
    }
    ...
    e.util.extend(n.prototype, {
      ...
      splitBoundaries: function () {
        ...
        D.isCharacterDataNode(e) && t > 0 && t < e.length && (e = D.splitDataNode(e, t), s ? (i -= t, n = e)  : n == e.parentNode && i >= D.getNodeIndex(e) && i++, t = 0),
        r(this, e, t, n, i)
      },
      normalizeBoundaries: function () {
        ...
        u = !0;
        D.isCharacterDataNode(n) ? n.length == i && s(n)  : (i > 0 && (u = n.childNodes[i - 1]) && D.isCharacterDataNode(u) && s(u), u = !this.collapsed),
        u ? D.isCharacterDataNode(e) ? t == 0 && o(e)  : t < e.childNodes.length && (s = e.childNodes[t]) && D.isCharacterDataNode(s) && o(s)  : (e = n, t = i),
        r(this, e, t, n, i)
      },
  ...
  p.prototype = {
    ...
    next: function () {
      var e = this._current = this._next;
      return e && (this._next = e !== this._last ? e.nextSibling : null, D.isCharacterDataNode(e) && this.clonePartiallySelectedTextNodes && (e === this.ec && (e = e.cloneNode(!0)).deleteData(this.eo, e.length - this.eo), this._current === this.sc && (e = e.cloneNode(!0)).deleteData(0, this.so))),
      e
    },
    remove: function () {
      var e = this._current,
  ...
  N.prototype = {
    ...
    cloneRange: function () {
      T(this);
      for (var e = new _(n(this)), t = $.length, r; t--; ) r = $[t],
      e[r] = this[r];
      return e
    },
    toString: function () {
  ...
  function t(e, t, n, r) {
    ...
    do u.insertBefore(t, t.previousSibling),
    o.moveToElementText(t);
    while ((a = o.compareEndPoints(f, e)) > 0 && t.previousSibling);
    f = t.nextSibling;
    if (a == - 1 && f && i.isCharacterDataNode(f)) {
      ...
      if (/[\r\n]/.test(f.data)) {
        u = o.duplicate(),
        n = u.text.replace(/\r\n/g, '\r').length;
        for (n = u.moveStart('character', n); u.compareEndPoints('StartToEnd', u) == - 1; ) n++,
        u.moveStart('character', 1)
      } else n = o.text.length;
      u = new s(f, n)
    } else f = (r || !n) && t.previousSibling,
  ...
  function n(e, t) {
    ...
    return a ? (n = e.node, r = n.parentNode)  : (n = e.node.childNodes, n = s < n.length ? n[s] : null, r = e.node),
  ...
  if (e.features.implementsDomRange && (!e.features.implementsTextRange || !e.config.preferTextRange)) (function () {
    ...
    o.createPrototypeRange(r, function (e, t, n, r, i) {
      ...
      if (e.startContainer !== t || e.startOffset != n || s) e.setEnd(r, i),
      e.setStart(t, n)
    }, function (e) {
  ...
  e.createNativeRange = function (e) {
    ...
    r.prototype.refresh = function () {
      ...
      this.textRange.compareEndPoints('StartToEnd', this.textRange) == 0 ? n = e = t(this.textRange, n, !0, !0)  : (e = t(this.textRange, n, !0, !1), n = t(this.textRange, n, !1, !1)),
  ...
  function u(e) {
    ...
    e: if (!t.length || t[0].nodeType != 1) n = !1;
      ...
      n = 1;
      for (var r = t.length; n < r; ++n) if (!v.isAncestorOf(t[0], t[n])) {
        n = !1;
        break e
      }
      n = !0
  ...
  function f(t) {
    ...
    if (t.docSelection.type == 'None') s(t);
      ...
      if (n && typeof n.text != 'undefined') a(t, n);
        ...
        for (var r, o = v.getDocument(n.item(0)), u = 0; u < t.rangeCount; ++u) r = e.createRange(o),
  ...
  function d(e) {
    ...
    if (typeof e.rangeCount != 'undefined') for (var s = 0, o = e.rangeCount; s < o; ++s) t[s] = g.inspect(e.getRangeAt(s));
  ...
  E,
  S,
  x = e.util.isHostMethod(window, 'getSelection'),
  ...
  L = m.areHostObjects(x, m.areHostProperties(x, [
    'anchorOffset',
    'focusOffset'
  ]));
  ...
  m.areHostMethods(x, [
    ...
    'getRangeAt',
    'removeAllRanges'
  ]) && typeof x.rangeCount == 'number' && e.features.implementsDomRange && function () {
  ...
  var D = !1,
  P;
  k && m.isHostMethod(k, 'createControlRange') && (P = k.createControlRange(), m.areHostProperties(P, [
    'item',
    'add'
  ]) && (D = !0)),
  ...
  m.isHostMethod(x, 'getRangeAt') ? H = function (e, t) {
   ...
   : L && (H = function (t) {
    ...
    n.collapsed !== this.isCollapsed && (n.setStart(t.focusNode, t.focusOffset), n.setEnd(t.anchorNode, t.anchorOffset)),
    n
  }),
  e.getSelection = function (e) {
    ...
    n = E(e),
    i = T ? r(e)  : null;
    return t ? (t.nativeSelection = n, t.docSelection = i, t.refresh(e))  : (t = new c(n, i, e), e._rangySelection = t),
    t
  },
  ...
  if (!N && L && m.areHostMethods(x, [
    ...
    P.addRange = O ? function (t, n) {
      if (D && T && this.docSelection.type == 'Control') l(this, t);
        ...
        var r;
        M ? r = this.rangeCount : (this.removeAllRanges(), r = 0),
        this.nativeSelection.addRange(o(t)),
        this.rangeCount = this.nativeSelection.rangeCount,
        this.rangeCount == r + 1 ? (e.config.checkSelectionRanges && (r = H(this.nativeSelection, this.rangeCount - 1)) && !g.rangesEqual(r, t) && (t = new y(r)), this._ranges[this.rangeCount - 1] = t, i(this, t, I(this.nativeSelection)), this.isCollapsed = S(this))  : this.refresh()
      }
    }
     : function (e, t) {
    ...
    if (!(m.isHostMethod(x, 'empty') && m.isHostMethod(C, 'select') && D && N)) return t.fail('No means of selecting a Range or TextRange was found'),
    !1;
    P.removeAllRanges = function () {
      try {
  ...
  if (N) j = function (t) {
    var n;
    e.isSelectionValid(t.win) ? n = t.docSelection.createRange()  : (n = v.getBody(t.win.document).createTextRange(), n.collapse(!0)),
    ...
    if (!L || typeof x.isCollapsed != 'boolean' || typeof C.collapsed != 'boolean' || !e.features.implementsDomRange) return t.fail('No means of obtaining a Range or TextRange from the user\'s selection was found'),
    !1;
    j = function (e) {
      var t;
      t = e.nativeSelection,
      t.anchorNode ? (t = H(t, 0), e._ranges = [
        t
      ], e.rangeCount = 1, t = e.nativeSelection, e.anchorNode = t.anchorNode, e.anchorOffset = t.anchorOffset, e.focusNode = t.focusNode, e.focusOffset = t.focusOffset, e.isCollapsed = S(e))  : s(e)
    }
  }
  P.refresh = function (e) {
    ...
    if (e) {
      ...
      for (; e--; ) if (!g.rangesEqual(t[e], this._ranges[e])) return !1;
      return !0
    }
  };
  var F = function (e, t) {
  ...
  P.removeRange = D ? function (e) {
    if (this.docSelection.type == 'Control') {
      ...
      n = v.getBody(n).createControlRange();
      for (var r, i = !1, s = 0, o = t.length; s < o; ++s) r = t.item(s),
  ...
  P.toString = function () {
    for (var e = [
    ], t = 0, n = this.rangeCount; t < n; ++t) e[t] = '' + this._ranges[t];
    return e.join('')
  },
  ...
  P.deleteFromDocument = function () {
    if (D && T && this.docSelection.type == 'Control') {
      for (var e = this.docSelection.createRange(), t; e.length; ) t = e.item(0),
      e.remove(t),
  ...
  function v(e, n, r, i) {
    ...
    if (b.isCharacterDataNode(n)) if (r == 0) r = b.getNodeIndex(n),
    n = n.parentNode;
     else {
  ...
  e.requireModules(['WrappedSelection',
  'WrappedRange']);
  var b = e.dom,
  w = function () {
    function e(e, t, n) {
  ...
  g.prototype = {
    doMerge: function () {
      for (var e = [
      ], t, n, r = 0, i = this.textNodes.length; r < i; ++r) t = this.textNodes[r],
      n = t.parentNode,
      e[r] = t.data,
      r && (n.removeChild(t), n.hasChildNodes() || n.parentNode.removeChild(n));
    ...
    toString: function () {
      for (var e = [
      ], t = 0, n = this.textNodes.length; t < n; ++t) e[t] = '\'' + this.textNodes[t].data + '\'';
      return '[Merge(' + e.join(',') + ')]'
    }
  };
  var k = [
  ...
  y.prototype = {
    ...
    postApply: function (e, t, n) {
      for (var r = e[0], i = e[e.length - 1], s = [
      ], o, u = r, a = i, f = 0, l = i.length, c, h, p = 0, d = e.length; p < d; ++p) c = e[p],
      (h = N(c, !n)) ? (o || (o = new g(h), s.push(o)), o.textNodes.push(c), c === r && (u = o.firstTextNode, f = u.length), c === i && (a = o.firstTextNode, l = o.getLength()))  : o = null;
      if (e = C(i, !n)) o || (o = new g(i), s.push(o)),
      o.textNodes.push(e);
      if (s.length) {
        p = 0;
    ...
    undoToTextNode: function (e, t, n) {
      t.containsNode(n) || (e = t.cloneRange(), e.selectNode(n), e.isPointInRange(t.endContainer, t.endOffset) && (v(n, t.endContainer, t.endOffset, [
        t
      ]), t.setEndAfter(n)), e.isPointInRange(t.startContainer, t.startOffset) && (n = v(n, t.startContainer, t.startOffset, [
        t
      ]))),
    ...
    applyToRange: function (e) {
      ...
      var t = a(e);
      if (t.length) {
        for (var n, r = 0, i = t.length; r < i; ++r) n = t[r],
    ...
    undoToRange: function (e) {
      ...
      i = t[t.length - 1];
      if (t.length) {
        for (var s = 0, o = t.length; s < o; ++s) n = t[s],
    ...
    isAppliedToRange: function (e) {
      ...
      for (var t = e.getNodes([3]), n = 0, r; r = t[n++]; ) if (!this.isIgnorableWhiteSpaceNode(r) && u(e, r) && this.isModifiable(r) && !this.getSelfOrAncestorWithClass(r)) return !1;
      return !0
    },
    isAppliedToSelection: function (t) {
      t = t || window,
      t = e.getSelection(t).getAllRanges();
      for (var n = t.length; n--; ) if (!this.isAppliedToRange(t[n])) return !1;
      return !0
    },
  ...
  function n(e, t) {
    ...
    r,
    i = o.getDocument(e.startContainer),
    s = e.cloneRange();
    return s.collapse(t),
  ...
  e.saveSelection = function (r) {
    ...
    if (e.isSelectionValid(r)) {
      ...
      l;
      u.sort(i);
      for (var c = 0, p = u.length; c < p; ++c) f = u[c],
      f.collapsed ? (l = n(f, !1), a.push({
        markerId: l.id,
        collapsed: !0
      }))  : (l = n(f, !1), f = n(f, !0), a[c] = {
        startMarkerId: f.id,
      ...
      for (c = p - 1; c >= 0; --c) f = u[c],
      f.collapsed ? f.collapseBefore((s || document).getElementById(a[c].markerId))  : (f.setEndBefore((s || document).getElementById(a[c].endMarkerId)), f.setStartAfter((s || document).getElementById(a[c].startMarkerId)));
  ...
  e.restoreSelection = function (n, i) {
    if (!n.restored) {
      for (var s = n.rangeInfos, o = e.getSelection(n.win), u = [
      ], a = s.length, f = a - 1, l, c; f >= 0; --f) {
        l = s[f],
        c = e.createRange(n.doc);
        if (l.collapsed) if (l = (n.doc || document).getElementById(l.markerId)) {
         ...
         else r(n.doc, c, l.startMarkerId, !0),
        r(n.doc, c, l.endMarkerId, !1);
        a == 1 && c.normalizeBoundaries(),
        u[f] = c
      }
      a == 1 && i && e.features.selectionHasExtend && s[0].backwards ? (o.removeAllRanges(), o.addRange(u[0], !0))  : o.setRanges(u),
      n.restored = !0
    }
  },
  e.removeMarkerElement = s,
  e.removeMarkers = function (e) {
    for (var t = e.rangeInfos, n = 0, r = t.length, i; n < r; ++n) i = t[n],
    i.collapsed ? s(e.doc, i.markerId)  : (s(e.doc, i.startMarkerId), s(e.doc, i.endMarkerId))
  }
  ...
  function i(e, t, n) {
    ...
    i = e;
    for (n = n || h.getDocument(e).documentElement; i && i != n; ) r.push(h.getNodeIndex(i, !0)),
    i = i.parentNode;
    return r.join('/') + ':' + t
  }
  function s(e, n, r) {
    n ? r || h.getDocument(n)  : (r = r || document, n = r.documentElement),
    e = e.split(':'),
    n = n,
    r = e[0] ? e[0].split('/')  : [
    ];
  ...
  function u(t, n, i) {
    n ? i = i || h.getDocument(n)  : (i = i || document, n = i.documentElement),
    t = /^([^,]+),([^,\{]+)({([^}]+)})?$/.exec(t);
    var o = t[4],
    u = r(n);
  ...
  function a(e, t, n) {
    return t ? n || h.getDocument(t)  : (n = n || document, t = n.documentElement),
    e = /^([^,]+),([^,]+)({([^}]+)})?$/.exec(e) [3],
    !e || e === r(t)
  }
  function f(t, n, r) {
    ...
    t = t.getAllRanges();
    for (var i = [
    ], s = 0, u = t.length; s < u; ++s) i[s] = o(t[s], n, r);
    return i.join('|')
  }
  function l(t, n, r) {
    n ? r = r || h.getWindow(n)  : (r = r || window, n = r.document.documentElement),
    t = t.split('|');
    for (var i = e.getSelection(r), s = [
    ], o = 0, a = t.length; o < a; ++o) s[o] = u(t[o], n, r.document);
  ...
  var c = function () {
    ...
    return function (t) {
      for (var n = [
      ], r = 0, i = t.length, s; r < i; ++r) s = t.charCodeAt(r),
      ...
      r = e,
      i = 0;
      for (s = n.length; i < s; ++i) o = (t ^ n[i]) & 255,
      t = t >>> 8 ^ r[o];
      return (t ^ - 1) >>> 0
    }
  }(),
  ...
  e.canDeserializeSelection = function (e, t, n) {
    var r;
    t ? r = n ? n.document : h.getDocument(t)  : (n = n || window, t = n.document.documentElement),
    e = e.split('|'),
    n = 0;
    for (var i = e.length; n < i; ++n) if (!a(e[n], t, r)) return !1;
    return !0
  },
  e.restoreSelectionFromCookie = function (e) {
    ...
    e: {
      ...
      for (var n = 0, r = t.length, i; n < r; ++n) {
        i = t[n].split('=');
        if (i[0].replace(/^\s+/, '') == 'rangySerializedSelection') if (i = i[1]) {
  ...
  function x(e, t, n, r) {
    ...
    if (!s) return console.log('Rangy null exception by Jon\'s hack.'),
    - 1;
    a = s.firstChild;
    while (a) {
      if (a === o) return - 1;
  ...
  E = s.areHostObjects(y, [
    'anchorNode',
    'focusNode'
  ] && s.areHostProperties(y, [
    'anchorOffset',
    'focusOffset'
  ]));
  ...
  s.areHostMethods(y, [
    ...
    'getRangeAt',
    'removeAllRanges'
  ]) && typeof y.rangeCount == 'number' && e.features.implementsDomRange && function () {
    var e = document.createElement('iframe');
    w.appendChild(e);
  ...
  var C = !1,
  k;
  w && s.isHostMethod(w, 'createControlRange') && (k = w.createControlRange(), s.areHostProperties(k, [
    'item',
    'add'
  ]) && (C = !0)),
  ...
  if (g) z = function (t) {
    ...
    z = function (e) {
      var t,
      n = e.nativeSelection;
      n.anchorNode ? (t = F(n, 0), e._ranges = [
        t
      ], e.rangeCount = 1, A(e), e.isCollapsed = c(e))  : O(e)
    }
  }
  ...
  function C(e, r, i, s) {
    ...
    if (n.isCharacterDataNode(r)) if (i == 0) i = n.getNodeIndex(r),
    r = r.parentNode;
     else {
  ...
  P.prototype = {
    ...
    postApply: function (e, t, n) {
      ...
      c,
      h;
      for (var p = 0, d = e.length; p < d; ++p) c = e[p],
      h = A(c, !n),
      h ? (o || (o = new M(h), s.push(o)), o.textNodes.push(c), c === r && (u = o.firstTextNode, f = u.length), c === i && (a = o.firstTextNode, l = o.getLength()))  : o = null;
      var v = O(i, !n);
    ...
    undoToTextNode: function (e, t, n) {
      if (!t.containsNode(n)) {
        var r = t.cloneRange();
        r.selectNode(n),
        r.isPointInRange(t.endContainer, t.endOffset) && (C(n, t.endContainer, t.endOffset, [
          t
        ]), t.setEndAfter(n)),
        r.isPointInRange(t.startContainer, t.startOffset) && (n = C(n, t.startContainer, t.startOffset, [
          t
        ]))
      }
    ...
    isAppliedToRange: function (e) {
      if (e.collapsed) return !!this.getSelfOrAncestorWithClass(e.commonAncestorContainer);
      var t = e.getNodes([3]);
      for (var n = 0, r; r = t[n++]; ) if (!this.isIgnorableWhiteSpaceNode(r) && h(e, r) && this.isModifiable(r) && !this.getSelfOrAncestorWithClass(r)) return !1;
      return !0
    },
    isAppliedToSelection: function (t) {
      t = t || window;
      ...
      r = n.getAllRanges(),
      i = r.length;
      while (i--) if (!this.isAppliedToRange(r[i])) return !1;
      return !0
    },
    toggleRange: function (e) {
      this.isAppliedToRange(e) ? this.undoToRange(e)  : this.applyToRange(e)
  ...
  function s(e, t) {
    ...
    s,
    o = n.getDocument(e.startContainer),
    u = e.cloneRange();
    return u.collapse(t),
  ...
  function a(n) {
    ...
    h;
    a.sort(u);
    for (var p = 0, d = a.length; p < d; ++p) h = a[p],
    h.collapsed ? (c = s(h, !1), f.push({
      markerId: c.id,
      collapsed: !0
    }))  : (c = s(h, !1), l = s(h, !0), f[p] = {
      startMarkerId: l.id,
    ...
    for (p = d - 1; p >= 0; --p) h = a[p],
    h.collapsed ? h.collapseBefore(i(f[p].markerId, r))  : (h.setEndBefore(i(f[p].endMarkerId, r)), h.setStartAfter(i(f[p].startMarkerId, r)));
  ...
  function f(n, r) {
    if (!n.restored) {
      ...
      for (var f = s.length, l = f - 1, c, h; l >= 0; --l) {
        ...
        } else o(n.doc, h, c.startMarkerId, !0),
        o(n.doc, h, c.endMarkerId, !1);
        f == 1 && h.normalizeBoundaries(),
        a[l] = h
      }
      f == 1 && r && e.features.selectionHasExtend && s[0].backwards ? (u.removeAllRanges(), u.addRange(a[0], !0))  : u.setRanges(a),
      n.restored = !0
    }
  }
  function l(e, t) {
  ...
  function c(e) {
    var t = e.rangeInfos;
    for (var n = 0, r = t.length, i; n < r; ++n) i = t[n],
    i.collapsed ? l(e.doc, i.markerId)  : (l(e.doc, i.startMarkerId), l(e.doc, i.endMarkerId))
  }
  e.requireModules(['DomUtil',
  'DomRange',
  'WrappedRange']);
  ...
  function a(e, t, n) {
    ...
    while (s && s != n) r.push(i.getNodeIndex(s, !0)),
    s = s.parentNode;
    return r.join('/') + ':' + t
  }
  function f(e, n, r) {
  ...
  function v(e, t, n) {
    ...
    var s = e.split('|');
    for (var o = 0, u = s.length; o < u; ++o) if (!h(s[o], t, r)) return !1;
    return !0
  }
  function g(e) {
    var t = e.split(/[;,]/);
  ...
  var r = function () {
    function e(e) {
      ...
      for (var n = 0, r = e.length, i; n < r; ++n) i = e.charCodeAt(n),
    ...
    return function (t) {
      ...
      i = - 1,
      s = r();
      for (var o = 0, u = n.length, a; o < u; ++o) a = (i ^ n[o]) & 255,
      i = i >>> 8 ^ s[a];
      return (i ^ - 1) >>> 0
    }
  }(),
